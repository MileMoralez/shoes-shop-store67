...
@section('content')
    <div class="bg-gray-50 py-16 text-center border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-4xl md:text-5xl font-serif text-gray-900 tracking-wide mb-4">Footwear</h1>
            <p class="text-gray-500 max-w-2xl mx-auto text-sm">
                Step into luxury. Premium sneakers, boots, and formal footwear.
            </p>
        </div>
    </div>
                ...
                <div class="sticky top-28">
                    ...
                    <div class="mb-8 border-b border-gray-100 pb-6">
                        <ul class="space-y-3 text-sm text-gray-500">
                            <li><a href="#" class="hover:text-black transition text-black font-medium">All Shoes</a></li>
                            <li><a href="#" class="hover:text-black transition">Sneakers</a></li>
                            <li><a href="#" class="hover:text-black transition">Boots</a></li>
                            <li><a href="#" class="hover:text-black transition">Formal</a></li>
                        </ul>
                    </div>
                </div>
            </aside>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
                    <div class="group relative">
                        <div class="w-full bg-gray-100 aspect-w-3 aspect-h-4 overflow-hidden h-[450px] relative">
                            <img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Premium Sneaker" class="w-full h-full object-cover object-center group-hover:opacity-90 transition-opacity">
                        ...
                        <div class="mt-6 flex justify-between">
                            <div>
                                <h3 class="text-sm text-gray-900 font-medium"><a href="#">Retro Runner</a></h3>
